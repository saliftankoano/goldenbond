            ...
            <div className="internal-container w-full max-w-7xl mx-auto flex flex-col lg:flex-row lg:mt-[60px] gap-8 lg:gap-0">
                ...
                <div className="w-full lg:w-[40%] lg:h-full">
                    <div className="text-container mb-8 lg:mb-[42px]">
                        <h2 className="tenor-font text-sm sm:text-base lg:text-[17px] leading-[20px] mb-3 lg:mb-[12px] uppercase">What we can do for you</h2>
                        <h1 className="max-w-full lg:max-w-[489px] font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-[48px] garamond-font leading-[110%] mb-6 lg:mb-[26px]">The Golden Bond Experience</h1>
                        <p className="text-sm sm:text-base lg:text-[16px] tenor-font leading-relaxed">Golden Bond is about celebrating connections that spark meaning.
                    ...
                    <div className="w-full sm:w-1/2 lg:w-1/2 flex flex-col gap-4 lg:gap-0">
                        <div className="flex flex-col items-center lg:items-end lg:justify-end lg:pt-[65px]">
                            <div className="flex flex-col lg:justify-end">
                                ...
                                <h2 className="title garamond-font text-lg sm:text-xl lg:text-[24px] leading-tight lg:leading-[25px] mt-3 lg:mt-[15px] w-full lg:w-[214px] text-center lg:text-right">Gems & Glamour: A Jewelry Showcase</h2>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center lg:items-end lg:justify-end lg:h-[50%]">
                            <div className="flex flex-col lg:justify-end">
                                ...
                                <h2 className="title garamond-font text-lg sm:text-xl lg:text-[24px] leading-tight lg:leading-[25px] mt-3 lg:mt-[15px] w-full lg:w-[214px] text-center lg:text-right">Magic & Mystery: A Jewelry Showcase</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full sm:w-1/2 lg:w-1/2 relative">
                        <div className="flex flex-col items-center lg:items-end lg:justify-end z-10 lg:pl-[15px]">
                            <div className="flex flex-col lg:justify-end">
                                ...
                                <h2 className="title garamond-font text-lg sm:text-xl lg:text-[24px] leading-tight lg:leading-[25px] mt-3 lg:mt-[15px] w-full lg:w-[214px] text-center lg:text-right">Sparkle & Shine Jewelry Showcase</h2>
                            </div>
                        </div>
