        ...
        <section className="w-full min-h-screen relative overflow-hidden py-12 md:py-16 lg:py-20">
            ...
            <div className="header flex flex-col items-center justify-center pt-8 md:pt-12 lg:pt-[15vh] relative px-4">
                <div className="header mb-2">
                    <h2 className="text-center text-[#B58E5A] text-sm md:text-base lg:text-[16px] font-bold tenor-font uppercase tracking-wider">FAQ</h2>
                </div>
                    ...
                    <Accordion type="single" collapsible className="w-full space-y-2">
                        <AccordionItem value="item-1" className="border-b border-gray-200">
                            <AccordionTrigger className="text-left text-sm sm:text-base lg:text-lg font-medium hover:text-[#B58E5A] transition-colors py-4 md:py-6">
                                How does pricing work for Large Private Events and Corporate bookings?
                            </AccordionTrigger>
                        ...
                        <AccordionItem value="item-2" className="border-b border-gray-200">
                            <AccordionTrigger className="text-left text-sm sm:text-base lg:text-lg font-medium hover:text-[#B58E5A] transition-colors py-4 md:py-6">
                                What if some guests don&apos;t want welded jewelry? Are there other options?
                            </AccordionTrigger>
                            <AccordionContent className="text-sm sm:text-base text-gray-700 leading-relaxed pb-4 md:pb-6">
